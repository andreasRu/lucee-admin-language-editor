...
component {
    ...
    /*********  
    *
    *  A encoding of XML values simplified
    *  See: https://stackoverflow.com/a/28152666/2645359 https://www.w3.org/TR/xml/#syntax
    *
    *********/
    public string function encodeXMLValue( string value required ) {
    ...
    /*********  
    *
    *  A simplified encoding of XML Attributes simplified
    *  See: https://stackoverflow.com/a/28152666/2645359 https://www.w3.org/TR/xml/#syntax
    *
    *********/
    public string function encodeXMLAttribute( string attribute required ) {
    
        return encodeXMLValue( arguments.attribute );
    ...
    public void function createUpdateWorkingLanguageResourceFile( string languageCode required,  struct formObject ) localmode="true" {
        ...
        if( structKeyExists( arguments, "formObject") ){
            ...
            for( name in local.KeyNames ){
                keyName=replaceNoCase( name, "~", ".", "All" );
                    if( form[ name ] != "" ){
                        dataKeysXMLCode=dataKeysXMLCode & "            <data key=""#encodeXMLAttribute( keyName )#"">#encodeXMLValue( form[ name ] )#</data>" & chr(10) 
                    }
                }
        }
        ...
        echo( "<?xml version=""1.0"" encoding=""UTF-8""?>" & chr(10) & 
             ...
             "        <language key=""" & encodeXMLAttribute( dataXML[ "XmlRoot.XmlAttributes.key" ] ) & """ label=""" & encodeXMLAttribute( dataXML[ "XmlRoot.XmlAttributes.label" ] ) & """>" & chr(10) & 
