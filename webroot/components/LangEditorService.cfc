...
component {
    ...
    public string function outputAsJson( struct data required) {
    ...
    public void function createUpdateWorkingLanguageResourceFile( string languageCode required,  struct formObject ) localmode="true" {
        ...
        if( fileExists(  "/workingPath/#encodeForXMLfilename( arguments.languageCode )#.xml") ){ 
        ...
        echo( "<?xml version=""1.0"" encoding=""UTF-8""?>" & chr(10) & 
             ...
             "        <language key=""" & encodeForXMLAttribute( dataXML[ "XmlRoot.XmlAttributes.key" ] ) & """ label=""" & encodeForXMLAttribute( dataXML[ "XmlRoot.XmlAttributes.label" ] ) & """>" & chr(10) & 
                                dataKeysXMLCode & chr(10) & 
             "        </language>"
        )
        }

        fileWrite(  "#expandPath("/workingPath")#/#encodeForXMLfilename( arguments.languageCode )#.xml",  xmlCode, "utf-8" );
    ...
    public any function downloadFileXML( string languageCode required ) localmode="true" {
        ...
        if( fileExists( "/workingPath/" & encodeForXMLfilename( arguments.languageCode ) & ".xml") ){
            cfheader( name="Content-Disposition", value="attachment; filename=#encodeForXMLfilename( arguments.languageCode )#.xml");
            cfcontent( type = "text/xml" file = "/workingPath/" & encodeForXMLfilename( arguments.languageCode ) & ".xml" deleteFile = "no" );
        }
    ...
    public void function pullResourceFileToWebAdmin( string language required ) localmode="true" {
        ...
        if( fileExists(  "/workingPath/#encodeForXMLfilename( arguments.language )#.xml") ){ 

            fileCopy(   source="/workingPath/#encodeForXMLfilename( arguments.language )#.xml", 
            destination="#expandPath("/luceeWebAdmin")#/#encodeForXMLfilename( arguments.language )#.xml" );
    ...
    public string function encodeForXMLfilename( string filename required ) localmode="true" {
	...
	*/
    public void function cleanWorkingDir( string lang ) localmode="true" {
        ...
        for ( language in langFilesToDelete ) { 
           if( fileExists(  "/workingPath/#encodeForXMLfilename( language )#.xml") ){ 
                fileDelete( "/workingPath/#encodeForXMLfilename( language )#.xml" );
            }
	...
	*/
	public struct function getWorkingDataForLanguageByLettercode( string languageISOLetterCode required ) localmode="true" {
        ...
        myXML=[:];
        xmlString = fileread( "/workingPath/#encodeForXMLfilename( arguments.languageISOLetterCode )#.xml", "UTF-8" );
