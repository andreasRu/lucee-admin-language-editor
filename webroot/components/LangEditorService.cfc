...
component {
	...
	public struct function deploySwitcherFilesToLuceeAdmin() localmode = true {
		...
		if(
			!fileExists( this.adminResourcePath & "/languageSwitcher.cfm" )
			...
			fileCopy( source = expandPath( "./" ) & "adminDeploy/admin_layout.cfm", destination = this.adminResourcePath & "/admin_layout.cfm" );
			...
			fileCopy( source = "https://raw.githubusercontent.com/lucee/Lucee/6.0/core/src/main/cfml/context/admin/resources/text.cfm", destination = this.adminResourcePath & "/resources/text.cfm" );
			fileCopy( source = "https://raw.githubusercontent.com/lucee/Lucee/6.0/core/src/main/cfml/context/admin/admin_layout.cfm", destination = this.adminResourcePath & "/admin_layout.cfm" );
